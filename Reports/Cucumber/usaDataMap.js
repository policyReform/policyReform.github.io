(function() {
      ...
      arcConfig: {
        ...
        popupTemplate: function(geography, data) {
          ...
          if ( ( data.origin && data.destination ) && data.origin.latitude && data.origin.longitude && data.destination.latitude && data.destination.longitude ) {
            return '<div class="hoverinfo"><strong>'+geography.name+'</strong><br>Origin: ' + JSON.stringify(data.origin) + '<br>Destination: ' + JSON.stringify(data.destination) + '</div>';
          }
          // Case with only country name
          else if ( data.origin && data.destination ) {
            return '<div class="hoverinfo"><strong>'+JSON.stringify(geography.name)+'</strong><br>' + data.origin + ' -> ' + data.destination + '</div>';
          }
          // Missing information
          else {
            return '';
    ...
    */
    ...
    function valNew( datumValue, optionsValue, context ) {
        if ( typeof context === 'undefined' ) {
          context = optionsValue;
          optionsValues = undefined;
        }
    ...
    function handleBubbles (layer, data, options ) {
      ...
      bubbles
        .enter()
          ...
          .style('fill', function ( datum ) {
              var fillColor;
              if(datum.useFillKey == false){
                fillColor = valNew(datum.fillKey, options.fillKey, datum);
            
              }else{
                fillColor = fillData[ val(datum.fillKey, options.fillKey, datum) ];
              }
