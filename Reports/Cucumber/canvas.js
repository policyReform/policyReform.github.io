    ...
    (function() {
        ...
        S._fTWm = function(h) {
            ...
            if ("undefined" === typeof S.pro.sCH && !cb) try {
                ...
                //commented waterMark
                v = h.width - w[S.fSDec("ld`rtsdUdyu")](S.fSDec("B`ow`rKR!Ush`m")).width;
    ...
    x = Pa.Chart = function() {
        ...
        n.prototype._updateOptions = function() {
            ...
            this.toolbar =
                ...
                //console.log('2888',this.options.zoomEnabled || this.panEnabled);
            ...
            hb(this);
            //console.log(this); console.log(this._toolBar);
            ...
            if (this.scaleBreaks)
                for (h =
                    ...
                    if ((!s(this.sessionVariables.newViewportMinimum) && this.sessionVariables.newViewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue || !s(this.options.minimum) && this.options.minimum >= this.scaleBreaks._appliedBreaks[h].startValue || !s(this.options.viewportMinimum) && this.viewportMinimum >= this.scaleBreaks._appliedBreaks[h].startValue) && (!s(this.sessionVariables.newViewportMaximum) && this.sessionVariables.newViewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue ||
                            !s(this.options.maximum) && this.options.maximum <= this.scaleBreaks._appliedBreaks[h].endValue || !s(this.options.viewportMaximum) && this.viewportMaximum <= this.scaleBreaks._appliedBreaks[h].endValue)) {
        ...
        W.prototype.getToolTipInnerHTML = function(a) {
            ...
            for (var h = 0; h < a.length; h++)
                ...
                (this.content && "function" === typeof this.content || this.contentFormatter)) a = {
                chart: this.chart,
                toolTip: this.options,
                entries: a
